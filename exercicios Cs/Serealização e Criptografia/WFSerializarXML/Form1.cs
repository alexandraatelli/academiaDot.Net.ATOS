...
namespace WFSerializarXML
{
    public partial class Form1 : Form
    {
        ...
        private void Bt_Serializar_Click(object sender, EventArgs e)
        {
            ...
            {
                Serializador.SerializarXML(pacientes, @"C:\Users\atell\Desktop\Atos\MeusProjAtos.Net\academiaDot.Net\exercicios Cs\Serealização e Criptografia\WFSerializarXML\bin\Debug\pacientes.xml");
                Tb_ConteudoArquivo.Text = Arquivo.LerArquivo(@"C:\Users\atell\Desktop\Atos\MeusProjAtos.Net\academiaDot.Net\exercicios Cs\Serealização e Criptografia\WFSerializarXML\bin\Debug\pacientes.xml");
            }
            else
            {
        ...
        {
            Serializador.DeserializarXML(pacientes, @"C:\Users\atell\Desktop\Atos\MeusProjAtos.Net\academiaDot.Net\exercicios Cs\Serealização e Criptografia\WFSerializarXML\bin\Debug\pacientes.xml");
        }
    }
}
