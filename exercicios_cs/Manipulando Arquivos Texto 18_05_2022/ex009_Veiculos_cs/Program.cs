...
string opcao = " ";
string nomeArquivo = "CadastroVeiculos.dat";

do
{
    Console.Clear();
    Console.WriteLine("1 - Cadastar o veículo que está entrnado na garagem");
    Console.WriteLine("2 - Exibir os veículos cadastrados");
    Console.WriteLine("3 - Sair do Programa");
    Console.WriteLine("Opção: ");
    opcao = Console.ReadLine();

    object? CadastrarVeiculo = null;
    
    switch (opcao)
    {
        case "1":
            //cadastrar um veículo;
            Util.CadastrarVeiculo("Cadastrando usuário", CadastrarVeiculo);
            break;
        case "2":
            //Exibir cadastro;
            Util.exibirLista("Exibindo a lista de usuários", CadastrarVeiculo);
            break;
        case "3":
